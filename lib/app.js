...
# --- BEGIN_HEADER ---
#
# app.js - dual licensed source code file
...
export class AppBase {
  constructor(state, { urlOptions, _fetch = fetch, ...options } = {}) {
    ...
    // default to an empty session expire check function if not provided
    const processSessionExpire =
      urlOptions.processSessionExpire ||
      function (res) {
        return res;
      };
